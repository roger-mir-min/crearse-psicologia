...
export class TermsComponent implements OnInit, CanComponentDeactivate {
 ...
 @ViewChild(ModalComponent) modal!: ModalComponent;
  ...
  ngOnInit() {
    this.titleService.setTitle("Términos y condiciones - Crearse");
    this.meta.updateTag({ property: 'og:site_name', content: 'Crearse' });
    this.meta.updateTag({ property: 'og:title', content: 'Términos y condiciones - Crearse' });
    ...
    this.meta.updateTag({ property: 'og:description', content: 'Términos y condiciones de los servicios ofrecidos por la psicoanalista Ximena Sosa.' });
    ...
    this.meta.updateTag({ name: 'twitter:title', content: 'Términos y condiciones - Crearse' });
